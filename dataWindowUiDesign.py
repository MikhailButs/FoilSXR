...
class Ui_DataWidget(object):
    def setupUi(self, DataWidget):
        ...
        DataWidget.resize(1203, 823)
        self.widget = QtWidgets.QWidget(parent=DataWidget)
        self.widget.setGeometry(QtCore.QRect(10, 10, 1181, 811))
        ...
        self.time_horizontalSlider = QtWidgets.QSlider(parent=self.widget)
    ...
    def retranslateUi(self, DataWidget):
        ...
        DataWidget.setWindowTitle(_translate("DataWidget", "Обработка данных"))
        self.label_8.setText(_translate("DataWidget", "Current time:"))
        self.time_label.setText(_translate("DataWidget", "-"))
